module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c153 = function(int_, frac, exp) { var x = parseFloat(int_ + frac + exp); return (x % 1 != 0) ? x.toString() : x.toString() + ".0"},
        peg$c154 = function(int_, frac) { var x = parseFloat(int_ + frac); return (x % 1 != 0) ? x.toString() : x.toString() + ".0"},
        peg$c155 = function(int_, exp) { return parseFloat(int_ + exp).toString(); },
        peg$c156 = function(int_) { return parseFloat(int_).toString(); },
